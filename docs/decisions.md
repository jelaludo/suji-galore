...
- The first study slice includes typed reading and exact composition. Statistics are local to a browser and split by system and mode. Multiple choice, adaptive difficulty, and aggregate research are deferred.
