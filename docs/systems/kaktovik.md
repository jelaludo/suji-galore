...
The Unicode chart states that its reference glyph shapes are not prescriptive. The local reference sheet and joins between components remain listed in `docs/verify.md` for human review.
